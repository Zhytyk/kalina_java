...
public class DecryptController {
    ...
    private List<Map<String, Map<String, String>>> decryptVisualData;
    private ObservableList<EncryptRow> rows;

    public void initData(List<Map<String, Map<String, String>>> decryptVisualKeys) {
        rows = FXCollections.observableArrayList();
        this.decryptVisualData = decryptVisualKeys;
    ...
    private void fillTable() {
        ...
        for (Map<String, Map<String, String>> map : decryptVisualData) {
